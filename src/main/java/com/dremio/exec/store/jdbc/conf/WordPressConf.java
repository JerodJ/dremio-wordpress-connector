...
@SourceType(value = "WordPressARP", label = "WordPress",uiConfig = "wordpress-layout.json")
public class WordPressConf extends AbstractArpConf<WordPressConf> {
  private static final String ARP_FILENAME = "arp/implementation/wordpress-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.wordpress.WordPressDriver";
